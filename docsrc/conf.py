...
intersphinx_mapping = {
    ...
    "arcpy_parquet": ("https://knu2xs.github.io/arcpy-parquet/", None),
}
...
# documentation.
html_theme_options = {
    "light_css_variables": {"color-api-name": "blue", "color-api-pre-name": "blue"},
    "dark_css_variables": {
...
autodoc_default_options = {"autosummary": True, "autosummary-no-titles": True}
...
htmlhelp_basename = f"spark_utils_doc"
